...
* https://docs.openshift.com/container-platform/4.12/service_mesh/v2x/ossm-observability.html#ossm-accessing-jaeger-console_observability[Accessing Jaeger in OpenShift Service Mesh]
...
** https://docs.openshift.com/container-platform/4.12/service_mesh/v2x/ossm-vs-community.html[Differences between OpenShift Service Mesh and plain Istio]
